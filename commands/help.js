    ...
    run: async(client, message, args) => {
        if(args[0] === "airlines"){
            ...
            const help1 = new MessageEmbed()
                ...
                .addField("f horny", `AWOOOOOOOOOOOOGA SEGGGGGGGGGGS`)
                .addField("f ping", `this literally exists to lmk that my bot isnt ded`)
                .addField("f user", `shows user info`)
                .addField("f spamqa", `spam ping the fuck out of that mf`)
            ...
            const help2 = new MessageEmbed()
                ...
                .addField("f le", `A very helpful command to make the bot send pictures of the amazing character "Fischl" from the game "Jenshin Impact"!`)
